...
class ParkingLotApi {
    ...
    constructor(httpClient) {
        this.baseRoute = '/api/v1/parkinglots';
    ...
    async getAll() {
        ...
        return res.map((parkingLot) => new ParkingLot(parkingLot));
    }
    ...
    async getLanes(id) {
        /** @type {object[]} */
        const res = await this.httpClient.get(`${this.baseRoute}/${id}/lanes`);
